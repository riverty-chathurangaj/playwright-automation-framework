...
Then('the response should satisfy contract {string}', function (
  { schemaValidator, currentRequest, currentResponse }: ContractFixtures,
  contractName: string,
) {
...
Then('the contract should be satisfied for {string} on {string}', function (
...
Then('the response schema should be valid against contract {string}', function (
  { schemaValidator, currentRequest, currentResponse }: ContractFixtures,
  contractName: string,
) {
  const endpoint = `${currentRequest.method} ${currentRequest.endpoint}`;
