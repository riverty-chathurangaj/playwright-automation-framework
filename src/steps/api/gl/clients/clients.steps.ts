...
import { ClientResponse } from '@api-models/gl/responses/client.response';
import { ClientDepartmentResponse } from '@api-models/gl/responses/client-department.response';
