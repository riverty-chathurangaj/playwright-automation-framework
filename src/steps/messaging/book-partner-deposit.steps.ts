...
When('I define a valid message for booking a partner deposit', function (
  { store }: Pick<BookPartnerDepositFixtures, 'store'>,
) {
...
When('I define a message for booking a partner deposit with the last published message id', function (
  { retrieve, store }: Pick<BookPartnerDepositFixtures, 'retrieve' | 'store'>,
) {
...
When('I set the book partner deposit message ID to be the same as the previous message', function (
  { retrieve, store }: Pick<BookPartnerDepositFixtures, 'retrieve' | 'store'>,
) {
...
When('I publish {int} book partner deposit message(s) with an invalid message ID to {string}', async function (
...
Then('the transactions from the book partner deposit message should exist in the database', async function (
  { dbClient, retrieve, store }: Pick<BookPartnerDepositFixtures, 'dbClient' | 'retrieve' | 'store'>,
) {
...
Then('the book partner deposit transactions should have the posting number {string}', function (
  { retrieve }: Pick<BookPartnerDepositFixtures, 'retrieve'>,
