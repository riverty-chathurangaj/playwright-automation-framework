...
Feature: Clients
  ...
  @api @gl-clients @fixme #TODO: This should return either 404 or 400 with a message indicating instance not found. 500 is not appropriate.
...
#    And each item in the response array should match schema "client-department"
  ...
  @api @gl-clients @fixme # The API responds with empty array. Shouldn't we return 404 or 400 with a message?
