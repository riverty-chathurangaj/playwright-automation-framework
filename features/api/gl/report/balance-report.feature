...
Feature: Balance — Balance Report
  ...
  # ── Negative ─────────────────────────────────────────────────────────────────
  @api @gl-report @fixme # The API currently returns 500 for invalid instanceId. It should return either 404 or 400 with a message indicating instance not found.
